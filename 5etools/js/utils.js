...
export const UrlUtil = globalThis.UrlUtil;
...
export const SortUtil = globalThis.SortUtil;
		...
		copyApplier: class {
			...
			static _doMod_addAllSaves ({copyTo, copyFrom, modInfo, msgPtFailed}) {
				return this._doMod_addSaves({
					...
					modInfo: {
						mode: "addSaves",
						saves: Object.keys(Parser.ATB_ABV_TO_FULL).flatMap(it => ({[it]: modInfo.saves})),
					},
					msgPtFailed,
				});
			}
			...
			static _doMod_addAllSkills ({copyTo, copyFrom, modInfo, msgPtFailed}) {
				return this._doMod_addSkills({
					...
					modInfo: {
						mode: "addSkills",
						skills: Object.keys(Parser.SKILL_TO_ATB_ABV).flatMap(it => ({[it]: modInfo.skills})),
					},
					msgPtFailed,
				});
			}
...
export const DataUtil = globalThis.DataUtil;
